...
class TicketSalesReport extends Page implements HasTable
{
    use InteractsWithTable;

    protected static string | \BackedEnum | null $navigationIcon = 'heroicon-o-chart-bar';
    protected static ?string $navigationLabel = 'تقارير مبيعات التذاكر';
    protected static string | null | \UnitEnum $navigationGroup = 'التقارير';
    protected static ?string $title = 'تقارير مبيعات التذاكر';
    protected static ?int $navigationSort = 1;
    

    protected static bool $shouldRegisterNavigation = true;

    protected string $view = 'filament.pages.ticket-sales-report';
